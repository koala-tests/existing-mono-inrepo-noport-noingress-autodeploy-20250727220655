# existing-mono-inrepo-noport-noingress-autodeploy-20250727220655
...
```
docker build -t existing-mono-inrepo-noport-noingress-autodeploy-20250727220655:latest .
docker run -p:5030:8080 existing-mono-inrepo-noport-noingress-autodeploy-20250727220655:latest
```
